...
public class HTGPubSiteHomePage {
   ...
   FileInputStream ip = new FileInputStream("C:\\Users\\Subhash\\eclipse-workspace\\HTGAutomation\\src\\test\\java\\prop\\Elements.Properties");
   prop.load(ip);
